...
export const ButtonClearFilter: FC<ButtonClearFilterProps> = ({clearFilters, amountOfFilters}) => {
  ...
  return (
    ...
    >
      <div className='flex justify-center items-center gap-2'>
        Limpar <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
